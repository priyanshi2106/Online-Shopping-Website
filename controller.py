...
def addproduct(request):
    ...
    conn = myconnection.connect('')
    cr = conn.cursor()
    query = "insert into products values(NULL,'" + pname + "','" + decription + "','" + str(cp) + "','" + str(
        sp) + "','" + str(discount) + "','" + str(photo.name) + "','" + str(quantity) + "','" + str(cname) + "')"
    cr.execute(query)
    conn.commit()
...
def editproduct(request):
    ...
    fs = FileSystemStorage()
    if hidden == "nofile":
        query = "update products set pname='" + pname + "',description='" + decription + "',cp='" + str(
            cp) + "',sp='" + str(sp) + "',discount='" + str(discount) + "',quantity='" + str(
            quantity) + "',cname='" + str(cname) + "' where pid='" + str(pid) + "'"
    else:
        photo = request.FILES['photo']
        fs.save("products/" + photo.name, photo)
        query = "update products set pname='" + pname + "',description='" + decription + "',cp='" + str(
            cp) + "',sp='" + str(sp) + "',discount='" + str(discount) + "',quantity='" + str(
            quantity) + "',photo='" + photo.name + "',cname='" + str(cname) + "' where pid='" + str(pid) + "'"
    conn = myconnection.connect('')
    cr = conn.cursor()
    cr.execute(query)
    conn.commit()
